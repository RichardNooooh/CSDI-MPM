...
function collect_bulk_plotting!(material_domain::Vector{MaterialPoint},
                                ...
                                plot_sidelengths::Array{Float64, 2}, plot_density::Array{Float64, 1},
    ...
    @threads for mp_index = 1:numMP
        ...
        plot_sidelengths[mp_index, 1] = material_point.side_lengths[1]
        plot_sidelengths[mp_index, 2] = material_point.side_lengths[2]
    ...
    vtk_grid(string(vtk_output_folder, "bulk_timestep_$(Int64(t_index / t_record))"), 
        ...
        vtk["Side Lengths", VTKPointData()] =         @views (plot_sidelengths[:, 1], plot_sidelengths[:, 2], zero_mp_array)
