...
function parseCommandLineArguments()
    s = ArgParseSettings(description="Runs a droplet simulation of a 2 droplet collsion with hyperelastic domain.")
    @add_arg_table! s begin
        "--simulation_name"
            arg_type = String
            default = "Droplet Collision"
        "--constitutive"
            arg_type = String
        ...
        "--mesh_file"
            ...
            arg_type = String
            default = "meshes/2D/twodisk_r1.0_r0.5_xa1.25_xb4.25_msh16.msh" # meshes/2D/twodisk_r1.0_r0.5_xa1.25_xb4.25_msh16.msh
        "--grid_dims"
        ...
        "--dest"
            ...
            arg_type = String
            default = "output/analysis/droplet_collision"
        "--output_name"
            help = "The name of the directory for the simulation results. The resulting path will " *
                   "then be DEST/OUTPUT_NAME/. Note that paths in Julia depends on the directory " *
        ...
        "--t_record"
            ...
            default = 1000
        "--v_alpha"
            help = "Defines velocity update (alpha = 1.0 for FLIP, 0.0 for PIC) for the second collision stage."
            arg_type = Float64
            default = 1.0
        "--gravity", "-g"
        ...
        "--surface_tension"
            ...
            default = 72e-6
        "--t_velocity_start"
            help = "Defines start time of velocity"
            arg_type = Float64
            default = 200.0
        "--velocity"
            help = "Defines how fast the droplets will be moving toward each other in each axial direction."
            arg_type = Float64
            default = 0.1
        "--v_alpha_initial"
...
include("DropletCollisionStudy.jl")
run(_arguments)
